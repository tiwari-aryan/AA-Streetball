...
class Player:
    ...
    def __init__(
        ...
        self.soundlist = [
            pygame.mixer.Sound("audio/Let's goo.wav"),
    ...
    def draw(self, win):
        ...
        if self.player_movement == 1:
            ...
            if self.possession == True:
                win.blit(
                    pygame.image.load("./images/basketball.png"),
                    (self.basketball_x, self.basketball_y),
                )
    ...
    def move(self, win, opponent_x, opponent_y):
        ...
        if self.player_movement == 1:
            ...
            right = True
            if (
                self.x >= opponent_x - 54
                and self.x <= opponent_x + 54
                and self.y >= opponent_y
                and self.y <= opponent_y + 54
            ):
                up = False
            if (
                self.x <= opponent_x
            ...
            if self.possession == True:
                ...
                if keys[pygame.K_r]:
                    ...
                    if distance_net > 1300:
                        distance_net = 1700
                    shot_probability = int(
                        (
                            (100 - ((450 - self.distance) / 6))
                            + (100 - distance_net / 10)
                        )
                        / 2
                    )
                    ...
                    if shot_percentage >= 0 and shot_percentage <= shot_probability:
                        ...
                        while self.basketball_x < 1790:
                            ...
                            win.blit(
                                pygame.image.load("images/basketball.png"),
                                (
                                    self.basketball_x + 20,
                                    self.basketball_y + (20 * rise),
                                ),
                            )
                        ...
                        while self.basketball_x >= 1690:
                            ...
                            win.blit(
                                pygame.image.load("images/basketball.png"),
                                (self.basketball_x + 10, self.basketball_y + 10),
                            )
                    ...
                    if (
                        keys[pygame.K_e]
                        and self.crossover_timer % 40 == 0
                        and not self.crossover_action
                    ):
                        if self.section == 1:
                            self.x -= 60
                        elif self.section == 2:
                        ...
                        self.crossover_action == True and self.crossover_timer % 40 == 0
                    ):
                        if self.section == 1:
                            self.x += 100
                        elif self.section == 2:
                    ...
                    if (
                        keys[pygame.K_f]
                        and self.in_and_out_timer % 40 == 0
                        and not self.in_and_out2
                        and not self.in_and_out1
                    ):
                        if self.section == 1:
                            self.x -= 50
                        elif self.section == 2:
                    ...
                    if (
                        keys[pygame.K_x]
                        and self.spinmove_timer % 40 == 0
                        and not self.spinmove2
                        and not self.spinmove1
                    ):
                        if self.section == 1:
                            self.x -= 6
                        elif self.section == 2:
                ...
                if keys[pygame.K_c]:
                    ...
                    if self.distance <= 54 and self.steal_action % 60 == 0:
                        steal_percentage = 0
                        steal_percentage = randint(
                            0, 100
                        )  # randomized percentage for successful steal
                        ...
                        if self.stamina >= 81 and self.stamina <= 100:
                            if steal_percentage >= 0 and steal_percentage <= 25:
                                self.reset_possession = True  # if the steal is successful, the possession changes, and the defender gains possession of the ball
                        self.stamina -= (
                            10  # each steal causes the defender to lose 10 stamina
                        )
        ...
        if self.player_movement == 2:
            ...
            right = True
            if (
                self.x >= opponent_x - 75
                and self.x <= opponent_x + 75
                and self.y >= opponent_y
                and self.y <= opponent_y + 75
            ):
                up = False
            if (
                self.x <= opponent_x
            ...
            if self.possession == True:  # Moves on Offense
                ...
                if keys[pygame.K_SPACE]:
                    ...
                    distance_net = math.sqrt((self.x - 1845) ** 2 + (self.y - 540) ** 2)
                    shot_probability = int(
                        75 + self.stamina / 100 + self.distance / 30 - distance_net / 20
                    )
