...
class Slider:
    ...
    def on_hover(self):
        ...
        if (
            mouse_location_x >= self.start_x - 7
            and mouse_location_y >= self.start_y - 7
            and mouse_location_x <= self.end_x
            and mouse_location_y <= self.end_y
        ):
            self.hover = True
    ...
    def on_click(self):
        ...
        if (
            mouse_location_x < 900
            and mouse_location_x > 870
            and mouse_location_y > 50
            and mouse_location_y < 65
            and left_click
        ) or self.volume == 0:
    ...
    def draw(self, win):
        ...
        win.blit(
            pygame.image.load("images/sliderball.png"), (self.start_x, self.start_y)
        )
